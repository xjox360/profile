  ...
  return (
    <div>
      ...
      <p>
        ...
        processes in retail and food industry, enhancing decision-making through
        the correct treatment of data and KPIs.
      </p>
      <p>
        ...
        Microsoft Excel (VBA), Google Sheets and Google App Script (Javascript).
      </p>
      <p>
        I have always been highlighted by my proactivity and solving problems
        approach, passionate about studying and learning every day, improving my
        skills continuously seeking to develop and implement productive,
        scalable, accurate and innovative solutions.
      </p>
      <p>
        And that's not all, I love web development, I've developed both work and
        personal projects using technologies like React JS, Redux, CSS,
